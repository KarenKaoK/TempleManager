...
- **transactions**: 收支明細（收入/支出共用）
  - `id`, `date`, `type`, `category_id`, `category_name`, `amount`, `payer_person_id`, `payer_name`, `handler`, `receipt_number`, `note`, `is_voided`, `source_type`, `source_id`, `adjustment_kind`, `adjusts_txn_id`, `is_system_generated`, `is_deleted`, `created_at`

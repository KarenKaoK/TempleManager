...
6. 打包（含 icon）
   - `python -m PyInstaller app/main.py --noconfirm --clean --windowed --onefile --name TempleManager --icon "assets/TempleManager.icns" --paths . --add-data "app/scheduler/scheduler_config.yaml:app/scheduler"`
7. 檢查產物
...
6. 打包（注意 `--add-data` 用 `;`）
   - `python -m PyInstaller app/main.py --noconfirm --clean --windowed --onefile --name TempleManager --icon "assets\\TempleManager.ico" --paths . --add-data "app/scheduler/scheduler_config.yaml;app/scheduler"`
7. 檢查產物

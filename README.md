...
### 🏠 信眾管理
- **戶籍資料建檔**：完整的戶長與家庭成員資料管理
- **信眾身份設定**：自定義信眾身份類別（如：丁、口等）
- **快速搜尋**：支援姓名、電話、地址等多種搜尋方式
- **資料編輯**：新增、修改、刪除信眾資料
...
### 🧾 收據列印系統
- **自動化編號**：採用民國年流水號格式（如：1130001），符合宮廟慣例
- **智能排版**：住址自動折行防呆，避免文字重疊
- **列印控制**：支援預覽、列印住址開關、宮廟印章浮水印
- **跨平台支援**：完美支援 Windows/macOS 字體與格式

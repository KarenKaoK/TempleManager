...
class EditMemberDialog(BasePersonDialog):
    ...
    def _fill(self, p: dict):
        ...
        self.birthday_ad_input.setText(ad_to_roc_string(normalize_ymd_text(p.get("birthday_ad", ""))))
        self.birthday_lunar_input.setText(ad_to_roc_string(normalize_ymd_text(p.get("birthday_lunar", ""))))

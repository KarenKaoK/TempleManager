...
from PyQt5.QtWidgets import (QDialog, QVBoxLayout, QGridLayout, QHBoxLayout, QLabel, QLineEdit, 
                             QComboBox, QPushButton, QDateEdit, QCheckBox)
...
class BasePersonDialog(QDialog):
    ...
    def get_data(self):
        return {
            ...
            "joined_at": self.joined_at_input.date().toString("yyyy-MM-dd"),
            "birthday_ad": self.birthday_ad_input.text(),
            "birthday_lunar": self.birthday_lunar_input.text(),
            "lunar_is_leap": self.lunar_leap_checkbox.isChecked(),
            "identity": self.identity_input.currentText(),
            "zodiac": self.zodiac_input.text(),
            "age": self.age_input.text(),
            "birth_time": self.birth_time_input.currentText(),
            "phone_home": self.phone_home_input.text(),
            "phone_mobile": self.phone_mobile_input.text(),
